  ...
  <style>
    * {
    ...
    .pagina {
      ...
      border-radius: 20px;
      box-shadow: 0 5px 25px rgba(255, 182, 193, 0.7);
      position: relative;
    ...
    .pagina::before {
      ...
      right: 10px;
      bottom: 10px;
      border: 1px solid rgba(204, 0, 102, 0.1);
      border-radius: 15px;
      pointer-events: none;
    }
    .pagina.active {
...
<div id="contenido">
  ...
  <!-- NUEVA PÁGINA CON EL MENSAJE ESPECIAL -->
  <div class="pagina">
...
<script>
  ...
  // Interacción para los corazones en la última página
